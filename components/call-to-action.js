class CallToAction extends HTMLElement {
    ...
    connectedCallback() {
        const showCaseOrFeatures = () => {
            const currentLocation = window.location.href;
            if (currentLocation.includes('chart-types') || currentLocation.includes('features')) return `<button onclick="window.location.href = 'index.html'">View showcase</button>`
            return `<button onclick="window.location.href = 'features.html'">Browse features</button>`
        }
        ...
        this.innerHTML = `
          ...
          <div class="container">
            ...
            <div class="btn-group">
                ${showCaseOrFeatures()}
                <button class="btn-primary" onclick="window.open('https://marketplace.atlassian.com/apps/1220925/custom-charts-for-jira-reports?hosting=cloud&tab=overview','_blank')">
